...
namespace PieViewer.Services
{
    ...
    /// </summary>
    internal sealed partial class PrintScreenListener : IDisposable
    {
        /// <summary>
        /// Hook ID
        /// </summary>
        ...
        public delegate Task PrintScreenCallback();
        public event PrintScreenCallback? PrintScreen;
        ...
        private IntPtr HookFunc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            if (nCode >= 0)
            {
                ...
                {
                    _ = Task.Factory.StartNew(() => PrintScreen?.Invoke());
                }
            }
